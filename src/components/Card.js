        ...
        <>
            <div className="card mb-3 w-xs-80 w-md-40 w-40 mw-xxl-50 " id='post'>
                <div className="card-body px-0 py-1  ">
                    <div className="postheader d-flex px-4 my-2 align-items-center">
                    ...
                    <hr />
                    <p className='my-2 text-start px-4 '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod ea doloremque aperiam perferendis eius suscipit quos tempore ab ex pariatur!</p>
